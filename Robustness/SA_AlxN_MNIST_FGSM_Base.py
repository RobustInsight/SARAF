...
destination_path = '../save/alex_mnist/alex_mnist_'
result_file_name ='results_AlexNet_MNIST_FGSM_base.csv'
...
def test_model(model, data_loaders, criterion, device, dataset_sizes):
    ...
    return test_loss, 95 # test_acc.item()
...
class robust_simannealer(Annealer):
    ...
    def energy(self):
        ...
        model = AlexNet_MNIST(num_classes=10, states_=self.state).to(device)
...
if __name__ == '__main__':
    ...
    data_loaders_, dataset_sizes_ = get_mnist_data(1000, 1000)
