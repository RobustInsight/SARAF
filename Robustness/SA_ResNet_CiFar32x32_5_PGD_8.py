...
destination_path = '../save/res18_cf32x32_5/res18_cf'
result_file_name = 'results_ResNet_Cifar32x32_5_PGD_base.csv'
LAYERS = 4
...
class robust_simannealer(Annealer):
    ...
    def energy(self):
        ...
        a_t_k = PGD(model, alpha=self.eps, steps=10, random_start=False)
...
if __name__ == '__main__':
    ...
    data_loaders_, dataset_sizes_ = get_cifar10_data_32(17000, 10000)
