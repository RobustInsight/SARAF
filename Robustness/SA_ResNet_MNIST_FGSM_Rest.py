...
source_file = 'results_ResNet_MNIST_FGSM_base.csv'
result_file = 'results_ResNet_MNIST_FGSM_total.csv'
model_path = '../save/res18_mnist/res18_mnist_'
...
if __name__ == '__main__':
    ...
    for ith, state_ in enumerate(chromosomes):
        ...
        model = resnet18_mnist(num_classes=10, states_=state_).to(device)
